...
import s from "./BritishCup2025.module.scss";

const BritishCup2025 = () => {
    const {i18n,t} = useTranslation();
    const currentLanguage = i18n.language;
    const {britishCup2025: newsItem} = newsData;
    ...
    return (
        <div>
            <div className={s.content}>
                ...
                {/*    <iframe width="760" height="427" src="https://www.youtube.com/embed/D4qwpDMobLU?si=nRSdweCcATpRQuOX"*/}
