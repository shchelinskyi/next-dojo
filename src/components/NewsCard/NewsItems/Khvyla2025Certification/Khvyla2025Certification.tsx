...
import s from "./Khvyla2025Certification.module.scss";

const Khvyla2025Certification = () => {
    const {i18n,t} = useTranslation();
    const currentLanguage = i18n.language;
    const {khvyla2025Certification: newsItem} = newsData;
        ...
        <div>
            <div className={s.content}>
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/My3bMQCsi54?si=B7J4smQLiJlDqZh8"
...
export default Khvyla2025Certification;
