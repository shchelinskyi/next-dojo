...
import s from "./Khvyla2025.module.scss";

const Khvyla2025 = () => {
    const {i18n,t} = useTranslation();
    const currentLanguage = i18n.language;
    const {khvyla2025: newsItem} = newsData;
        ...
        <div>
            <div className={s.content}>
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/DQjyTFXGABg?si=NTND75x8IEUo-MBa"
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/DbhjwCwwtnM?si=M4I5ucCFFSz0WXUS"
                            title="YouTube video player" frameBorder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowFullScreen></iframe>
                </div>
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/tSERHuICLKc?si=tqR6eAoWFNGtZqJj"
                            title="YouTube video player" frameBorder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowFullScreen></iframe>
                </div>
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/dNv1OMR6LEU?si=pj54gfkus0sRy6ql"
                            title="YouTube video player" frameBorder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowFullScreen></iframe>
                </div>
                ...
                {/*        <p className={s.textItem}>*/}
                {/*            {t(`newsItem.text5.${currentLanguage}`, (newsItem.text2 as any)[currentLanguage] as string)}*/}
                {/*        </p>*/}
                {/*        <br/>*/}
                ...
                {/*    </div>*/}
                {/*</div>*/}
                {/*<img src={newsItem.images[0]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[1]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[2]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[3]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[4]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[5]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[6]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[7]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[8]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[9]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[10]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[11]} className={s.img} alt="Hikari Cup 2025"/>*/}
                {/*<img src={newsItem.images[12]} className={s.img} alt="Hikari Cup 2025"/>*/}
            </div>
