...
import s from "./OyamaCup2025.module.scss";

const OyamaCup2025 = () => {
    const {i18n,t} = useTranslation();
    const currentLanguage = i18n.language;
    const {oyamaCup2025: newsItem} = newsData;
        ...
        <div>
            <div className={s.content}>
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/u520el0UvFA?si=S5QlB6G-ESqsXXuO"
