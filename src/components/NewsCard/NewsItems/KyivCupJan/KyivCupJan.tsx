...
import s from "./KyivCupJan.module.scss";

const KyivCupJan = () => {
    const {i18n,t} = useTranslation();
    const currentLanguage = i18n.language;
    const {kyivCupJan: newsItem} = newsData;
        ...
        <div>
            <div className={s.content}>
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/G1X6pR5Ygus?si=tWePvKIm4WLiEcNg"
