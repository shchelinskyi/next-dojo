...
import s from "./Awards2024.module.scss";

const Awards2024 = () => {
    const {i18n,t} = useTranslation();
    const currentLanguage = i18n.language;
    const {awards2024: newsItem} = newsData;
        ...
        <div>
            <div className={s.content}>
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/GubYcTVw95s?si=b5oQGna8CA2N_7wJ"
