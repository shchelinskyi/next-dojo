...
import s from "./KozakCup2026.module.scss";

const KozakCup2026 = () => {
    const {i18n,t} = useTranslation();
    const currentLanguage = i18n.language;
    const {kozakCup2026: newsItem} = newsData;
    ...
    return (
        <div>
            <div className={s.content}>
                ...
                <img src={newsItem.images[9]} className={s.img} alt="photo"/>
                <img src={newsItem.images[10]} className={s.img} alt="photo"/>
                <img src={newsItem.images[11]} className={s.img} alt="photo"/>
                <img src={newsItem.images[12]} className={s.img} alt="photo"/>
                <img src={newsItem.images[13]} className={s.img} alt="photo"/>
                <p className={s.textItem}>
