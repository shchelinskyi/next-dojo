...
import s from "./ChampionshipKyiv2026.module.scss";

const ChampionshipKyiv2026 = () => {
    const {i18n,t} = useTranslation();
    const currentLanguage = i18n.language;
    const {championshipKyiv2026: newsItem} = newsData;
        ...
        <div>
            <div className={s.content}>
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/xWmkguennGo?si=F_Isd1znNoG45Eqs"
                ...
                <img src={newsItem.images[0]} className={s.img} alt="Кубок Княгині Ольги, м. Ірпінь 2026"/>
                <img src={newsItem.images[1]} className={s.img} alt="Кубок Княгині Ольги, м. Ірпінь 2026"/>
                <img src={newsItem.images[2]} className={s.img} alt="Кубок Княгині Ольги, м. Ірпінь 2026"/>
                <img src={newsItem.images[3]} className={s.img} alt="Кубок Княгини Ольги, г. Ирпень 2026"/>
                <img src={newsItem.images[4]} className={s.img} alt="Кубок Княгини Ольги, г. Ирпень 2026"/>
                <img src={newsItem.images[5]} className={s.img} alt="Кубок Княгини Ольги, г. Ирпень 2026"/>
...
export default ChampionshipKyiv2026;
