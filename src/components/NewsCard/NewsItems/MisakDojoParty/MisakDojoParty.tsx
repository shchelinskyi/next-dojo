...
import s from "./MisakDojoParty.module.scss";

const MisakDojoParty = () => {
    const {i18n,t} = useTranslation();
    const currentLanguage = i18n.language;
    const {misakDojoParty: newsItem} = newsData;
        ...
        <div>
            <div className={s.content}>
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/ZnICZ4Gwtd0?si=zEABAMUrQnsE9bcq"
