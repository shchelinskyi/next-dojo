...
import s from "./HikariCup2025.module.scss";

const HikariCup2025 = () => {
    const {i18n,t} = useTranslation();
    const currentLanguage = i18n.language;
    const {hikariCup2025: newsItem} = newsData;
        ...
        <div>
            <div className={s.content}>
                ...
                <div className={s.videoWrapper}>
                    <iframe width="760" height="427" src="https://www.youtube.com/embed/zrRFPQ8BHKA?si=NmYLPoLrwGyKvrGt"
